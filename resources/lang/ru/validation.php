    ...
    */
    ...
    'custom' => [
        ...
        'name' => [
            ...
            'max'      => 'Максимальное значение имени не должно привышать :max символов',
        ],

        'username' => [
            'required' => 'Имя обязательно к заполнению',
            'string'   => 'Имя должно быть строкой',
            'max'      => 'Максимальное значение логина не должно привышать :max символов',
        ],

        'type_account' => [
            'required' => 'Тип аккаунта обязательно к заполнению'
        ],

        'email' => [
            'required' => 'E-mail адрес обязательно к заполнению',
            'string'   => 'E-mail адрес должен быть строкой',
            'email'    => 'E-mail адрес должен быть e-mail адресом',
            'max'      => 'Максимальное значение e-mail не должно привышать :max символов',
            'unique'   => 'Этот e-mail уже занят',
        ],

        'password' => [
            'required' => 'Пароль обязательно должен быть заполнен',
            'string'   => 'Пароль должен быть строкой',
            'min'      => 'Минимально значение пароля должно быть больше чем :min символов',
        ]
    ],
